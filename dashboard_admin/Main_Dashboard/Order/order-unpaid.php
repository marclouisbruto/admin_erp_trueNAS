    ...
    <div class="order-content">
        <table>
            ...
            if (isset($adminID)) {
                ...
                WHERE tbl_order.status = 'To Ship' OR tbl_order.status = 'Shipping'
                ORDER BY
                ...
                if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($currentOrderID !== $orderID) {
                            echo "
                                <tr><td colspan='5' id='order-details'>Order ID: $orderID &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp;&nbsp; Order Date: " . $formattedDatetime . " &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; Status: Unpaid  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; Total Amount: Php ". number_format($totalAmount, 2) ."
                            ";
