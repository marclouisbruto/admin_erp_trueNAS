...
<body>
    <section id="leftbar">
        ...
        <ul class="side-menu">
            ...
            <li class="each">
                <a href="order.php" class='current'><i class='bx bxs-cart-download icon'></i>Order<i class='bx bx-chevron-down down'></i><i class='bx bx-chevron-up up' ></i></a>
                <ul class="dropdown">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($currentOrderID !== $orderID) {
                            ...
                            $currentOrderID = $orderID; // Update the current order ID
                                echo "<button type='submit' onclick='confirmGenerate(".$orderID.")' id='input-generate'>Generate Receipt</button>";
                            echo "</td></tr>";
                        }
                        echo "
                        <tr>
    ...
    <script>
        function confirmGenerate(orderID) {
            Swal.fire({
                title: 'Generate Receipt for \n Order ID ' + orderID + ' ?',
                showCancelButton: true,
                ...
                if (result.isConfirmed) {
                    window.location.href = 'order-invoice.php?orderID=' + orderID;
                }
            });
        }
    </script>
